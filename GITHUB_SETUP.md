...
The repo is live at https://github.com/brandonduplantier-juice/CraftPath
The online optimizer is deployed at https://craftpath.onrender.com

## Pushing code changes (you have git set up already)
...
## Cutting a release (for the desktop download)
Using GitHub CLI (installed):
...
## Deploying the online version (already done on Render)
...
- Free tier spins down after 15 min idle (~50s cold start on next visit)
